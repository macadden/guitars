...
class ManageWoods extends Component {
    ...
    updateForm = (element) => {
        const newFormdata = update(element, this.state.formdata, 'woods'); /**-'woods': porque necesito pasar el tipo de "form" está realizando
                                                                            esta acción (update). Recordar que estoy en el componente "products".*/
        this.setState({
            formError: false,
    ...
    submitForm = (event) => {
        ...
        if (formIsValid) { //Envio una acción
    ...
    componentDidMount() { //machea (adjunta) la lista de woods; la lista gris es traída por esto.
