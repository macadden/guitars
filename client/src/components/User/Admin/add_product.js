//VER EL VIDEO 116 OTRA VEZ para entender mejor esto.
...
class AddProduct extends Component {
    ...
    state = {
        ...
        formdata: {
            ...
            brand: {
                element: 'select', //OTRO TIPO DE ELEMENTO.
                value: '',
                config: {
                    label: 'Product Brand',
                    name: 'brands_input',
    ...
    updateForm = (element) => {
        const newFormdata = update(element, this.state.formdata, 'products'); /**-'products': porque necesito pasar el tipo de "form" está realizando
